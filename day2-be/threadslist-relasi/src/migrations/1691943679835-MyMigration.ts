...
export class MyMigration1691943679835 implements MigrationInterface {
    name = 'MyMigration1691943679835'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "follows" ("id" SERIAL NOT NULL, CONSTRAINT "PK_8988f607744e16ff79da3b8a627" PRIMARY KEY ("id"))`);
